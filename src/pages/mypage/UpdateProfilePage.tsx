...
const UpdateProfilePage = () => {
  ...
  return (
    <div className="flex flex-col items-center w-[calc(100vw-26.1875rem)] h-[calc(100vh-3.1875rem)] mb:w-full mb:h-full bg-Light_Layout-200 dark:bg-Dark_Layout-300">
      ...
      <div className="mt-[5.5rem] relative mb:mt-[8rem] w-[47.0625rem] mb:w-[36rem] h-[31.75rem] mb:h-[40rem] bg-Light_Layout-300 flex flex-col items-center rounded-[1rem] dark:bg-Dark_Layout-200">
        ...
        <div className="mt-[2rem] w-[38.75rem] mb:w-[32rem] flex justify-between items-center">
          <div className="text-[1.5625rem] text-Light_Text_Name dark:text-Dark_Text_Name">닉네임</div>
          <input
            className="pl-[2rem] focus:outline-none flex items-center w-[31.4375rem] h-[4rem] mb:w-[24rem] bg-Light_Layout-400 dark:bg-Dark_Layout-400 rounded-[1.5625rem] text-[1.5625rem] text-Light_Text_Name dark:text-Dark_Text_Name"
            value={nickName}
        ...
        <div className="mt-[2rem] w-[38.75rem] mb:w-[32rem] flex justify-between items-center">
          ...
          <div className="pl-[2rem] pr-[1rem] flex items-center justify-between w-[31.4375rem] mb:w-[24rem] h-[4rem] bg-Light_Layout-400 dark:bg-Dark_Layout-400 rounded-[1.5625rem]">
            <input
