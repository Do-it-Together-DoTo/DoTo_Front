...
const MydataPage = () => {
  ...
  const graphData = {
    all: `${((data.all / initialMax.all) * 25).toFixed(3)}rem`,
    category1: `${((data.category1 / initialMax.category1) * 25).toFixed(3)}rem`,
    category2: `${((data.category2 / initialMax.category2) * 25).toFixed(3)}rem`,
    category3: `${((data.category3 / initialMax.category3) * 25).toFixed(3)}rem`,
    category4: `${((data.category4 / initialMax.category4) * 25).toFixed(3)}rem`,
  };
  ...
  const Options = {};
  return (
    <div className="pb-[7rem] flex flex-col items-center w-[calc(100vw-26.1875rem)] h-[calc(screen-3.1875rem)] mb:w-full bg-Light_Layout-200 dark:bg-Dark_Layout-300">
      ...
      <div className="mt-[2.5rem] flex flex-col items-center w-[49.25rem] mb:w-[36rem] h-[31.625rem] bg-Light_Layout-300 rounded-[0.9375rem] dark:bg-Dark_Layout-400">
        <div className="mt-[1.875rem] w-[8.5rem] h-[1.8125rem] font-semibold text-[1.5rem] text-Light_Text_Name dark:text-Dark_Text_Name">
          나의 투두 기록
        </div>
        <div className="mt-[2.75rem] w-[44.3125rem] mb:w-[32rem] h-[1.625rem] flex justify-between items-center">
          <div className="w-[5.4375rem] h-[1.5rem] text-[1.25rem] mb:text-[1rem] mb:w-[4.2rem] flex justify-center items-center text-Light_Text_Name dark:text-Dark_Text_Name">
            전체
          </div>
          <div className="relative w-[25rem] h-[1.0625rem] bg-Light_Layout-100 rounded-lg rounded-10">
            <div
              className={`absolute h-[1.0625rem] rounded-lg rounded-10 bg-Button`}
              style={{ width: graphData.all }}
            />
          </div>
          <div className="w-[1rem] h-[1.5rem] text-[1rem] flex justify-center items-center dark:text-Dark_Text_Name">
            {data.all}/{initialMax.all}
          </div>
        </div>
        <div className="mt-[3.25rem] w-[44.3125rem] mb:w-[32rem] h-[1.625rem] flex justify-between items-center">
          <div className="w-[5.4375rem] h-[1.5rem] text-[1.25rem] mb:text-[1rem] mb:w-[4.2rem] flex justify-center items-center text-Light_Text_Name dark:text-Dark_Text_Name">
            카테고리1
          </div>
          <div className="relative w-[25rem] h-[1.0625rem] bg-Light_Layout-100  rounded-lg rounded-10">
          ...
          <div className="w-[1rem] h-[1.5rem] text-[1rem] flex justify-center items-center text-Light_Text_Name dark:text-Dark_Text_Name">
      ...
      <div className="mt-[2.5rem] flex flex-col items-center mb:w-[36rem] w-[49.25rem] h-[45.8125rem] bg-Light_Layout-300 rounded-[0.9375rem] dark:bg-Dark_Layout-400">
        <div className="mt-[1.875rem] w-[8.5rem] h-[1.8125rem] font-semibold text-[1.5rem] text-Light_Text_Name dark:text-Dark_Text_Name">
          나의 코인 기록
        </div>
        <div className="mt-[3.8125rem] w-[41.125rem] mb:w-[34rem] h-[9.375rem] flex justify-between">
          <div className="w-[19.8125rem] h-[9.375rem] mb:w-[16rem] flex flex-col items-center bg-Light_Layout-400 dark:bg-Dark_Layout-300 rounded-lg">
          ...
          <div className="w-[19.8125rem] mb:w-[16rem] h-[9.375rem] flex flex-col items-center bg-Light_Layout-400 dark:bg-Dark_Layout-300 rounded-lg">
        ...
        <div className="mt-[2.125rem] w-[41.125rem] mb:w-[34rem] h-[23.8125rem] flex justify-between">
          <div className="w-[19.8125rem] h-[23.8125rem] mb:w-[16rem] flex flex-col items-center bg-Light_Layout-400 dark:bg-Dark_Layout-300 rounded-lg">
