...
//TODO Form 정규식 로직 , 라이브러리 활용할지 ? , 비동기 통신
const SignIn = () => {
  return (
      ...
      <div className="w-[22.5rem] h-[42.25rem] flex flex-col items-center">
        ...
        <form className="mt-[6.9375rem] flex flex-col justify-center">
          ...
          <div className="mt-[0.1875rem] flex items-center w-[5.3125rem] h-[1.8175]">
            ...
            <label htmlFor="isCheck" className="pl-[0.5rem] text-[10px] font-pre text-Dark_Text_Contents">
              자동 로그인
            </label>
          </div>
        </form>
        <button className="mt-[1.75rem] w-[19.875rem] h-[2.75rem] bg-Button font-pre font-bold text-Light_Layout-100 text-[15px] border rounded-lg rounded-10">
          로그인
        </button>
