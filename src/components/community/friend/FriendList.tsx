...
const Friends = () => {
  ...
  return (
    <section className="flex flex-col gap-6 w-[25.6875rem] items-center">
      ...
      <div className="w-[24rem] h-[28rem] rounded-[1.875rem] bg-Light_Layout-400 flex flex-col items-center px-8 py-[1.1875rem] gap-4 overflow-y-auto scrollbar-hide dark:bg-Dark_Layout-400">
        {friends.map((friend) => (
