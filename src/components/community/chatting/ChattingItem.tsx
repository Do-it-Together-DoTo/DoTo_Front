...
const ChattingItem = ({ chatting }: ChattingItemProps) => {
  return (
    <Link to={`${chatting.roomId}`}>
      <div className="flex w-[44rem] h-24 gap-14 items-center rounded-xl border-[0.1rem] border-Dark_Text_Contents text-xs text-Light_CategoryText_Icon_Contents pl-4 justify-start">
