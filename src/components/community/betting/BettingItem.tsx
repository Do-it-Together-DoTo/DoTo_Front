...
const BettingItem = ({ betting, isParticipate }: BettingItemProps) => {
  ...
  return (
    <div className="flex w-[31rem] h-10 py-3 gap-14 items-center rounded-xl border-[0.1rem] border-Dark_Text_Contents text-xs text-Light_CategoryText_Icon_Contents pl-4 pr-16 justify-between dark:text-Dark_CategoryText_Icon dark:border-Dark_CategoryText_Icon">
