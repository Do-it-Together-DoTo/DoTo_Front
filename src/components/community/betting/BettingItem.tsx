...
const BettingItem = ({ betting, isParticipate }: BettingItemProps) => {
  ...
  return (
    <div className="flex items-center w-full dt:h-10 dt:py-3 dt:gap-14 rounded-xl border-[0.1rem] border-Dark_Text_Contents text-xs text-Light_CategoryText_Icon_Contents pl-4 pr-16 justify-between dark:text-Dark_CategoryText_Icon dark:border-Dark_CategoryText_Icon">
