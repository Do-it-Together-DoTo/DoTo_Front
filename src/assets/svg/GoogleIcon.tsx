...
const SvgGoogleIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    {...props}
  >
    <circle cx={25} cy={25} r={24.55} fill="#fff" stroke="#F2F2F2" strokeWidth={0.9} />
    <path fill="url(#GoogleIcon_svg__a)" d="M12 12h25v25H12z" />
    <defs>
      <pattern id="GoogleIcon_svg__a" width={1} height={1} patternContentUnits="objectBoundingBox">
        <use xlinkHref="#GoogleIcon_svg__b" transform="scale(.0125)" />
      </pattern>
      <image
